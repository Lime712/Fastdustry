...
use crate::arc_core::math::geom::mathf::DEGREES_TO_RADIANS;
...
impl Vec2 {
    ...
    pub fn trns(&mut self, angle: f32, amount: f32) -> Vec2 {
        self.set(amount, 0).rotate(angle)
    }
    ...
    pub fn trns_exact(&mut self, angle: f32, amount: f32) -> Vec2 {
        self.set(amount, 0).rotate_exact(angle * DEGREES_TO_RADIANS)
    }
