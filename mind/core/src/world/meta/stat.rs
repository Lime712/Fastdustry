...
lazy_static! {
    ...
    pub static ref BUILD_SPEED_MULTIPLIER: Stat =
    ...
    pub static ref LIQUID_CAPACITY: Stat =
    ...
    pub static ref POWER_CONNECTIONS: Stat =
        Stat::new(StatCat::POWER, "powerConnections".to_string());
    pub static ref BASE_POWER_GENERATION: Stat =
    ...
    pub static ref PRODUCTION_TIME: Stat =
